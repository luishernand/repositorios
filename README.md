...
| [Netflix](https://github.com/luishernand/NETFLIX/tree/main) | Data Analitycs |  Este proyecto consiste en un análisis del impacto en cuanto a tiempo y dinero invertido en ver Series y Películas en la plataforma Netflix El de entender los patrones de consumo y preferencias utilizando técnicas de ciencia de datos |
